...
1. 本模板对Overleaf极为友好，编译时只需要将compiler设置为XeLaTeX。
...
3. 在TeX live环境下，可能会遇到\bibliography报错的情况，需要把编译链中的bibtex换成biber，具体可参考[Issue#2](https://github.com/pasteller/njusttt/issues/2#issue-2511395379)。
